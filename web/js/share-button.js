!function (e) {
	if ("object" == typeof exports)
		...
		var f;
		"undefined" != typeof window ? f = window : "undefined" != typeof global ? f = global : "undefined" != typeof self && (f = self), f.ShareButton = e()
	}
}(function () {
...
// 22.1.3.31 Array.prototype[@@unscopables]
				...
				if ([][UNSCOPABLES] == undefined)
					_dereq_('./$.hide')(Array.prototype, UNSCOPABLES, {});
				module.exports = function (key) {
					...
					_createClass(ShareButton, [{
							...
							value: function _public(action) {
								...
								if (typeof element === 'undefined')
									instances = _get(Object.getPrototypeOf(ShareButton.prototype), '_objToArray', this).call(this, document.getElementsByTagName('share-button'));
								else
							...
							value: function _setup(element, opts) {
								...
								if (typeof element === 'undefined')
									...
									if (typeof instances === 'object')
										instances = _get(Object.getPrototypeOf(ShareButton.prototype), '_objToArray', this).call(this, instances);
								}
								...
								if (this.config.networks.facebook.enabled && this.config.networks.facebook.loadSdk)
							...
							value: function _fixFlyout() {
								...
								if (flyouts[0].substring(0, this.config.ui.namespace.length) !== this.config.ui.namespace)
									flyouts[0] = '' + this.config.ui.namespace + flyouts[0];
								if (flyouts[1].substring(0, this.config.ui.namespace.length) !== this.config.ui.namespace)
				...
				var ShareUtils = (function () {
					...
					_createClass(ShareUtils, [{
							...
							value: function _isMobile() {
								if (navigator.userAgent.match(/Android|iPhone|PhantomJS/i) && !navigator.userAgent.match(/iPod|iPad/i))
									return true;
								return false;
							}
						}]);
